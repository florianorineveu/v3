...
#[ORM\Table(name: 'tool_short_url')]
#[ORM\UniqueConstraint(name: 'uniq_tool_short_url_slug', fields: ['slug'])]
#[ORM\Index(name: 'idx_tool_short_url_enabled_slug', fields: ['enabled', 'slug'])]
