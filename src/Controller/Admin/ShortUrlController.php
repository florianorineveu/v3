...
#[Route('/url-raccourcie', name: 'admin_short_url_')]
final class ShortUrlController extends AbstractController
{
    ...
    {
        return $this->render('admin/short_url/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, ShortenUrl $shortenUrl): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_short_url_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('admin/short_url/new.html.twig', [
            'short_url' => $shortUrl,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin/short_url/show.html.twig', [
            'short_url' => $shortUrl,
        ]);
    }
    ...
    public function edit(Request $request, ShortUrl $shortUrl, EntityManagerInterface $entityManager, ShortenUrl $shortenUrl): Response
    {
        ...
        return $this->render('admin/short_url/edit.html.twig', [
            'short_url' => $shortUrl,
            'form' => $form,
        ]);
    }
